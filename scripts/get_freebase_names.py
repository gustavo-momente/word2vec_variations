...
def create_parsers():
    ...
    parser = argparse.ArgumentParser(description='Convert mids from a Freebase triplets file (it is assumed that the'
                                                 ' file is in the format generated by clear_FB15k.py) to their names.'
                                                 '\nIt\'s required a developer key to the Freebase api. ')
